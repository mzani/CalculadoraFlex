package br.com.zani.calculadoraflex.ui.signup
...
import br.com.zani.calculadoraflex.model.User
...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveInRealTimeDatabase() {
        ...
        FirebaseDatabase.getInstance().getReference("Users")
            ...
            .addOnCompleteListener{
                if (it.isSuccessful){
                    Toast.makeText(this, "Usuario criado com sucesso",
                ...
                {
                    Toast.makeText(this, "Erro ao criar usuario",
                        Toast.LENGTH_LONG).show()
                }
            }
    }
